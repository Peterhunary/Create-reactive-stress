...
public final class Config {
    ...
    static {
        ...
        addMultiplier(builder, "Press", 3.0);
        addMultiplier(builder, "Mixer", 2.0);
        addMultiplier(builder, "MillStone", 1.5);
        addMultiplier(builder, "Crafter", 2);
        addMultiplier(builder, "Saw", 1.5);
        addMultiplier(builder, "CrushingWheel", 4);
