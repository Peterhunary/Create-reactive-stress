...
public class ActualFlywheelVisual extends KineticBlockEntityVisual<ActualFlywheelBlockEntity> implements SimpleDynamicVisual {
	...
	public ActualFlywheelVisual(VisualizationContext context, ActualFlywheelBlockEntity blockEntity, float partialTick) {
		...
		shaft.setup(ActualFlywheelVisual.this.blockEntity)
